...
static unsigned int cal_range_slice;
...
static unsigned char sensor_LUT_index;

const unsigned char sensor_LUT[256]=
{
 255,250,235,220,200,
 180,175,170,165,160,
 156,155,154,153,153,
...
unsigned long measure_sensor()
{
    ...
    cal_range_slice = (cal_dry_pulses - cal_wet_pulses) >> 8;
    sensor_LUT_index = (new_nr_pulses - cal_wet_pulses) / cal_range_slice;
    return sensor_LUT[sensor_LUT_index & 0xFF];
}
